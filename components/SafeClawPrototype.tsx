...
const screens: ProductScreen[] = [
  ...
  { group: "실행", id: "dispatch", label: "공지 발송", num: "08", title: "메일과 문자 전송 결과를 기록합니다.", subtitle: "운영 기준 채널은 메일과 문자로 고정하고, 채널별 접수 결과를 남깁니다.", primary: "발송 로그", status: "live", mappedTo: "/dispatch · 공지 발송", scope: ["n8n dispatch", "메일/SMS", "발송 로그"], metrics: [["메일", "연결"], ["문자", "연결"]]},

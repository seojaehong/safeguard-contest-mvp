...
Source HEAD: `504839e5fb49d7a5cafc80531aa73686a496af18`

Production `/api/build-info`: `db896d45116418c7a185d9dad443a198be7a8de3`
...
Live rollup source head: `504839e5fb49d7a5cafc80531aa73686a496af18`

Live rollup matches production: `true`

Note: current HEAD `504839e5fb49d7a5cafc80531aa73686a496af18` is an evidence-only or tooling refresh pushed after the live-exact artifact set. Production is still `db896d45116418c7a185d9dad443a198be7a8de3`, and the live rollup remains exact for that deployed marker.
...
- Wiki candidate generation content is measured separately from that browser fixture: `PASS_LIVE_PRODUCTION_WIKI_CANDIDATE_FALLBACK_CONTENT_MATRIX_LLM_ENHANCED_RUNTIME_BLOCKED`; deterministic fallback local/live scenarios `5/5` and `5/5`, while the enhanced provider remains `0/5` with blocker `distributed_rate_limit_unavailable_before_ai_generation`. This does not read the production candidate queue or claim enhanced LLM quality: queueRead=`false`, fixtureAcceptedAsGenerationProof=`false`, enhancedLive=`false`, humanReviewCompleted=`false`, exact saved Share=`MISSING_EVIDENCE`, Wiki/RLS=`APPROVAL_GATED/APPROVAL_GATED`.

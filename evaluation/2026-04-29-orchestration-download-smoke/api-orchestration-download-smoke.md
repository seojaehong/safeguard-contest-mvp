...
| Gemini | /api/ask 내부 generateAnswer | live | 점검결과 요약<br>위험성평가표<br>TBM<br>안전보건교육<br>외국인 전송본 | 11 | 산업안전 실무용 코파일럿으로서, 대구 달서구 창고업의 고중량 박스 적재 및 수작업 운반 작업에 대한 질문에 제공된 근거 목록 범위 내에서 답변 드립니다.

---

### 1) 핵심 판단

대구 달서구 창고업에서 고중량 박스 적재 및 수작업 운반 작업을 수행하는 사업주는 해당 작업으로  |
...
| HWPX | ok | 10094 | evaluation\2026-04-29-orchestration-download-smoke\files\대성창고-risk-assessment.hwpx |
| PDF | ok | 275894 | evaluation\2026-04-29-orchestration-download-smoke\files\대성창고-risk-assessment.pdf |

...
| 형식 | 결과 | 바이트 | 파일 |
| --- | --- | ---: | --- |
| TXT | ok | 3546 | evaluation\final-99-current-no-mutation-2026-08-27-after-local\orchestration-download\files\세이프건설-risk-assessment.txt |
| JSON | ok | 4068 | evaluation\final-99-current-no-mutation-2026-08-27-after-local\orchestration-download\files\세이프건설-risk-assessment.json |
| CSV | ok | 8343 | evaluation\final-99-current-no-mutation-2026-08-27-after-local\orchestration-download\files\세이프건설-risk-assessment.csv |
| XLS | ok | 14850 | evaluation\final-99-current-no-mutation-2026-08-27-after-local\orchestration-download\files\세이프건설-risk-assessment.xls |
| DOC | ok | 6604 | evaluation\final-99-current-no-mutation-2026-08-27-after-local\orchestration-download\files\세이프건설-risk-assessment.doc |
| HTML | ok | 4124 | evaluation\final-99-current-no-mutation-2026-08-27-after-local\orchestration-download\files\세이프건설-risk-assessment.html |

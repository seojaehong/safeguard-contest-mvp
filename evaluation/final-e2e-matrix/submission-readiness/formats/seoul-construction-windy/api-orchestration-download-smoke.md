...
| 형식 | 결과 | 바이트 | 파일 |
| --- | --- | ---: | --- |
| TXT | ok | 6398 | evaluation\final-e2e-matrix\submission-readiness\formats\seoul-construction-windy\files\세이프건설-risk-assessment.txt |
| JSON | ok | 6930 | evaluation\final-e2e-matrix\submission-readiness\formats\seoul-construction-windy\files\세이프건설-risk-assessment.json |
| CSV | ok | 9586 | evaluation\final-e2e-matrix\submission-readiness\formats\seoul-construction-windy\files\세이프건설-risk-assessment.csv |
| XLS | ok | 16341 | evaluation\final-e2e-matrix\submission-readiness\formats\seoul-construction-windy\files\세이프건설-risk-assessment.xls |

...
async function readMetrics(page) {
  ...
  return page.evaluate(() => {
    ...
    return {
      ...
      documentWorkbenchHead: rect(".document-workbench-head"),
      safetyBrief: rect(".safety-brief-dashboard"),
      safetyBriefActions: rect(".safety-brief-actions"),
      riskAssessmentEditCta: rect(".safety-brief-edit-action"),
      safetyBriefShareCta: rect(".safety-brief-share-action"),
      documentSecondaryActions: rect(".document-secondary-actions"),
      documentProvenanceSummary: rect(".document-provenance-drawer > summary"),
      documentDeepReviewSummary: rect(".document-deep-review > summary"),
      ...
      documentToolbar: rect(".document-toolbar"),
      documentFieldStrip: rect('[data-testid="document-section-field-strip"]'),
      documentSectionActions: rect('[data-testid="document-section-actions"]'),
      ...
      shareLanguageCard: rect("[data-share-owner='language-preview']"),

...
- 기상 선조회: live / 단시간 흐림, 강수없음, 기온 17℃, 풍속 2m/s (초단기실황/초단기예보/단기예보/기상특보 반영)
- /api/ask: live / 문서 11종
...
| --- | --- | --- | --- | ---: | --- |
| 기상청 현재/초단기/단기/특보/영향예보 | /api/weather 선조회<br>/api/ask 내부 fetchWeatherSignal | live | 현장 브리프 날씨<br>위험성평가표 작업조건<br>TBM 기상 신호<br>작업중지 기준 | 5 | 단시간 흐림, 강수없음, 기온 17℃, 풍속 2m/s (초단기실황/초단기예보/단기예보/기상특보 반영) |
...
| Gemini | /api/ask 내부 generateAnswer | live | 점검결과 요약<br>위험성평가표<br>TBM<br>안전보건교육<br>외국인 전송본 | 11 | 세이프건설 서울 성수동 근린생활시설 외벽 도장 공사 현장에 대한 위험성평가 및 TBM/안전보건교육 기록 초안입니다.

### 1. 핵심 판단
본 작업은 **이동식 비계**를 이용한 고소 작업으로, **산업안전보건법 제38조(안전조치)**에 따른 추락 방지 조치가 필수적입니다. 특히 오후 |
...
| ALL_TXT | ok | 66340 | evaluation\submission-readiness\formats\seoul-construction-windy\files\세이프건설-safeguard-workpack.txt |
| ALL_CSV | ok | 97350 | evaluation\submission-readiness\formats\seoul-construction-windy\files\세이프건설-safeguard-workpack.csv |
| ALL_XLS | ok | 132874 | evaluation\submission-readiness\formats\seoul-construction-windy\files\세이프건설-safeguard-workpack.xls |
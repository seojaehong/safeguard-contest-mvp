...
| Gemini | /api/ask 내부 generateAnswer | live | 점검결과 요약<br>위험성평가표<br>TBM<br>안전보건교육<br>외국인 전송본 | 11 | 그린메탈 경기 안산 공장 배관 용접·절단 화기작업에 대한 현장 검토용 초안입니다. 본 초안은 제공된 법령 근거(산업안전보건법 및 시행령·시행규칙 등)를 바탕으로 작성되었습니다.

### 1. 핵심 판단
*   **위험요인 식별:** 화기작업(용접·절단)에 따른 불꽃 비산 및 가연물 인화 |
...
| PDF | ok | 285348 | evaluation\submission-readiness\formats\ansan-manufacturing-foreign-hotwork\files\그린메탈-risk-assessment.pdf |

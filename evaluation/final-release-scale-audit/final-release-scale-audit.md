...
Generated: 2026-07-05T10:43:50.760Z
...
|------|---------|---------|
| existing-web-api-ask | pass | {"status":200,"elapsedMs":1191,"missingDeliverables":[],"deliverableCount":11,"scenario":{"companyName":"그린메탈","companyType":"제조업","siteName":"경기 안산 제조공장","workSummary":"그린메탈 경기 안산 제조공장 옥외 용접 작업","workerCount":6,"weather |
| ai-connect-page | pass | {"status":200,"elapsedMs":342} |
...
| Gate | Verdict | Details |
|------|---------|---------|
| supabase-kakao-provider-enabled | blocked | {"status":400,"elapsedMs":121,"supabaseOrigin":"https://mewqgevgdgghhatqtuos.supabase.co","disabledReason":"Supabase returned Unsupported provider: provider is not enabled","redirectTo":"https://www.safeclaw.kr/auth/call |

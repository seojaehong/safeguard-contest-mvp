...
Generated: 2026-07-05T10:32:20.913Z
...
|------|---------|---------|
| existing-web-api-ask | pass | {"status":200,"elapsedMs":797,"missingDeliverables":[],"deliverableCount":11,"scenario":{"companyName":"그린메탈","companyType":"제조업","siteName":"경기 안산 제조공장","workSummary":"그린메탈 경기 안산 제조공장 옥외 용접 작업","workerCount":6,"weatherN |
| ai-connect-page | pass | {"status":200,"elapsedMs":309} |
...
| mcp-token-query-indexes-approved | blocked | {"hasOrgCreatedIndex":false,"hasSiteCreatedIndex":false,"approvalRequired":true,"operatorAction":"After approval, add indexes for mcp_tokens(org_id, created_at desc) and mcp_tokens(site_id, created_at desc)."} |

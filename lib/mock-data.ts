...
function buildOfficialStyleTbmBriefing(scenario: ReturnType<typeof inferScenario>) {
  ...
  return [
    ...
    `- ${profile.actions[1]}`,
    `- ${profile.actions[2]}`,
    "- 기상 API 또는 현장 기상 확인 결과가 악화되면 작업반장이 작업중지 여부를 재판단합니다.",
    "",
    "[4. 작업중지 기준]",
    `- ${profile.questions[0]}`,
    `- ${profile.questions[1]}`,
    "- 위험구역 통제, 보호구 미착용, 기상 악화, 미숙련 작업자 이해 부족 시 작업을 시작하지 않습니다.",
    "",
    "[5. 참석자 확인]",
    "- 작업자는 핵심 위험요인과 작업중지 기준을 구두 복창합니다.",
    "- 보호구 착용 상태와 위험구역 통제 상태를 상호 확인합니다.",
    "- 신규·외국인·미숙련 작업자는 쉬운 한국어 또는 통역/번역 메시지로 이해 여부를 추가 확인합니다.",
    "",
    "[6. 사진·증빙 위치]",
    "- 작업 전 현장 상태, 보호구 착용, 위험구역 통제, TBM 실시 사진을 작업일지·모바일 앱·문서팩 첨부자료에 남깁니다.",
    "- 참석자 서명, 구두 복창 확인, 신규/외국인 이해 확인 기록을 함께 보관합니다.",
    "",
    "[7. 교육시간 인정 검토]",
    "- 위험성평가 결과, 교육 내용, 대상, 시간, 확인증빙이 함께 남는 경우에만 교육 증빙 활용 가능 여부를 검토합니다.",
    "- TBM 자체가 법정교육을 자동 대체한다고 표현하지 않습니다.",
    "",
    "[확인 질문]",
    "1. 오늘 가장 큰 유해·위험요인과 작업중지 기준을 말할 수 있습니까?",
    "2. 기상 악화 또는 현장 변화가 생기면 누구에게 보고하고 어디서 대기합니까?",
...
function buildPhotoEvidenceDraft(scenario: ReturnType<typeof inferScenario>) {
  ...
  return [
    ...
    "- 조치 전 사진: 위험구역 상태, 방호조치 전 상태, 접근통제 전 상태",
    `- 조치내용: ${profile.actions[0]}`,
    "- 조치 후 사진: 개선조치 완료 상태, 표지·차단·보호구 확인 상태",
    `- 위험요인 2: ${profile.hazards[1]}`,
    "- 조치 전 사진: 장비·동선·작업환경의 미조치 상태",
    `- 조치내용: ${profile.actions[1]}`,
    "- 조치 후 사진: 작업반장 또는 관리감독자 확인 후 상태",
    "",
    "[3. TBM 및 교육 증빙]",
    "- TBM 실시 사진 또는 모바일 기록:",
    "- 참석자 확인 또는 서명:",
...
function buildOfficialStyleTbmLog(scenario: ReturnType<typeof inferScenario>) {
  ...
  return [
    ...
    "- 기상 API 또는 현장 기상 확인 결과가 악화되면 작업반장·관리감독자가 작업 가능 여부를 재판단",
    "",
    "[근로자 확인 사항]",
    "- 보호구 착용: □ 안전모 □ 안전화 □ 턱끈 □ 작업별 보호구",
    "- 건강상태: □ 이상 없음 □ 확인 필요",
    "- 음주·피로 여부: □ 이상 없음 □ 확인 필요",
    "",
    "[참석자 확인]",
    "TBM 내용 숙지 여부: 전원 구두 복창 및 서명 예정",
    "보호구 착용 상태: 상호 점검",
    "위험구역 표시 및 통제: 확인",
    "신규·외국인·미숙련 작업자: 쉬운 한국어/통역/번역 메시지로 이해 여부 별도 확인",
    "",
    "[사진·영상 기록 메모]",
    "- 작업 전 현장 상태, 보호구 착용, 위험구역 통제, TBM 실시 사진을 기록합니다.",
    "- 사진/영상 파일명, 모바일 앱 기록 ID, 작업일지 보관 위치를 남깁니다.",
    "",
    "[교육시간 인정 검토]",
    "- 위험성평가 결과를 반영하고 교육 대상·내용·시간·서명·사진/모바일 기록이 남는 경우에만 증빙 활용 가능 여부를 검토합니다.",
    "- 본 기록은 법정 제출 서식을 자동 대체하지 않는 현장 보조 초안입니다.",
    "",
    "[미조치 위험요인 / 후속조치]",
    `- ${profile.questions[0]}`,
    `- ${profile.questions[1]}`

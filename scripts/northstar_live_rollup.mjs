...
export function buildNorthstarLiveRollup(rootDir, buildInfo, generatedAt = new Date().toISOString()) {
  ...
  return {
    ...
    llmWikiCandidateContentMatrix: {
      ...
      localPassed: asNumber(recordAt(llmWikiCandidateContentMatrix, "afterLocal")?.passedCount),
      localFailed: asNumber(recordAt(llmWikiCandidateContentMatrix, "afterLocal")?.failedCount),
      livePassed: asNumber(recordAt(llmWikiCandidateContentMatrix, "afterLive")?.passedCount),
      liveFailed: asNumber(recordAt(llmWikiCandidateContentMatrix, "afterLive")?.failedCount),
      sourceHead: asString(recordAt(llmWikiCandidateContentMatrix, "afterLive")?.sourceHead),
      productionCommit: asString(recordAt(llmWikiCandidateContentMatrix, "afterLive")?.productionCommit),

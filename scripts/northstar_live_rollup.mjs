...
export function buildNorthstarLiveRollup(rootDir, buildInfo, generatedAt = new Date().toISOString()) {
  ...
  return {
    ...
    llmWikiCandidateContentMatrix: {
      ...
      localPassed: asNumber(recordAt(llmWikiCandidateContentMatrix, "evidenceVisibilityAfterLocal")?.passedCount),
      localFailed: asNumber(recordAt(llmWikiCandidateContentMatrix, "evidenceVisibilityAfterLocal")?.failedCount),
      livePassed: asNumber(recordAt(llmWikiCandidateContentMatrix, "evidenceVisibilityAfterLive")?.passedCount),
      liveFailed: asNumber(recordAt(llmWikiCandidateContentMatrix, "evidenceVisibilityAfterLive")?.failedCount),
      sourceHead: asString(recordAt(llmWikiCandidateContentMatrix, "evidenceVisibilityAfterLive")?.sourceHead),
      productionCommit: asString(recordAt(llmWikiCandidateContentMatrix, "evidenceVisibilityAfterLive")?.productionCommit),

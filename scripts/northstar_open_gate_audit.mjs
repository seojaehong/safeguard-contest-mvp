...
const EVIDENCE_PATHS = Object.freeze({
  ...
  liveCurrentDocumentsShareGeometry: path.join("evaluation", "live-current-documents-share-geometry-2026-08-26", "report.json"),
